...
export function Header() {
  return (
    <header className="sticky top-0 right-0 left-0 z-50 flex flex-col items-center justify-between gap-y-4 bg-zinc-50 px-10 py-5 font-semibold text-zinc-900 uppercase md:flex-row">
