...
export function Header() {
  ...
  return (
    <header className="fixed top-0 right-0 left-0 z-50 flex flex-col items-center justify-between gap-y-2 bg-zinc-50 px-5 py-3 font-semibold text-zinc-900 uppercase shadow-md transition-all md:flex-row md:px-10 md:py-5">
